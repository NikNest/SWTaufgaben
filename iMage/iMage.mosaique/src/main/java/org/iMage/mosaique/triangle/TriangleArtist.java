...
public class TriangleArtist extends AbstractArtist implements IMosaiqueArtist<BufferedArtImage> {
  ...
  /**
   * Create an artist who works with {@link UpperTriangleShape TriangleShapes} and {@link LowerTriangleShape TriangleShapes}
   *
   * @param images
  ...
  public void drawTileForRegion(BufferedImage region, BufferedArtImage target) {
    ...
    int averageLower = UpperTriangleCalculator.getInstance().averageColor(region);
